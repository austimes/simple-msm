...
| `operate_off_road_mobile_equipment` | `transport_other_non_road__residual_incumbent` | 1 | `temporary_residual` | `operate_off_road_mobile_equipment` | residual method | Remaining non-road transport coverage split from the former transport-other bucket. |
...
| `construct_buildings_and_infrastructure` | `construction_other__residual_incumbent` | 1 | `temporary_residual` | `construct_built_assets` | residual method | Keep as construction coverage until a real construction pathway exists. |
...
| `account_energy_system_fugitive_emissions` | `residual_fugitives__residual_incumbent` | 1 | `temporary_residual` | `account_remaining_fugitive_emissions` | residual method | Keep until fugitive emissions can be assigned to domestic and export resource supply chains. |
...
| `account_residual_water_waste` | `water_waste_other__residual_incumbent` | 1 | `temporary_residual` | `provide_water_and_wastewater_services` | residual method | Keep as water-services residual until water and wastewater methods are authored. |
| `account_residual_waste_emissions` | `residual_waste__residual_incumbent` | 1 | `temporary_residual` | `treat_and_dispose_solid_waste` | residual method | Keep until explicit waste-management methods exist. |
...
| `operate_remaining_domestic_activity` | `other_other__residual_incumbent` | 1 | `temporary_residual` | `account_remaining_other_sectors` | residual method | Keep as final domestic residual coverage while gaps are being eliminated. |
