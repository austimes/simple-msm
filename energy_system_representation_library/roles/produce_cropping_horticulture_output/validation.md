# Produce cropping and horticulture output
...
- Current direct-energy improvements remain embodied in `agriculture__cropping_horticulture__mitigated` until the role boundary is split further.
