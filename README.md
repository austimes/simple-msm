...
- The current crude-steel pilot keeps `make_crude_steel` available as an aggregate pathway bundle while adding an optional decomposition into non-H2 DRI crude steel, DRI production, and DRI melt/refine child roles.
