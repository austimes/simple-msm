...
const EXPECTED_ROLE_IDS = new Set([
  ...
  'operate_off_road_mobile_equipment',
  'make_crude_steel',
  ...
  'construct_buildings_and_infrastructure',
  'provide_water_and_wastewater_services',
  'treat_and_dispose_solid_waste',
...
test('energy system representation library package structure is internally consistent', () => {
  ...
  assert.equal(totalMethods, 80);
  assert.equal(totalMethodYearRows, 480);
