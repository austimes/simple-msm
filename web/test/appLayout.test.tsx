...
test('AppLayout includes the Explorer, Additionality, Compare, Library, State Schema, Methods, and Model Formulation nav items in the top-level order', () => {
  ...
  assert.ok(compareIndex > additionalityIndex, 'expected Compare after Additionality');
