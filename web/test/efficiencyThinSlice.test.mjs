...
const EXPECTED_AUTONOMOUS_TRACK_IDS = [
  ...
  'coal_mining__background_diesel_efficiency_drift',
  'coal_mining__background_electricity_efficiency_drift',
  'domestic_aviation__background_aircraft_efficiency_drift',
  'domestic_shipping__background_vessel_engine_efficiency_drift',
  ...
  'international_aviation__background_fleet_renewal_drift',
  'international_shipping__background_cii_fleet_efficiency_drift',
  'oil_and_gas_extraction__background_diesel_efficiency_drift',
  'oil_and_gas_extraction__background_gas_turbine_efficiency_drift',
  'rail_freight__background_diesel_loco_efficiency_drift',
  'rail_freight__background_electric_traction_efficiency_drift',
  'rail_passenger__background_diesel_efficiency_drift',
  'rail_passenger__background_electric_efficiency_drift',
...
const EXPECTED_PACKAGE_IDS = [
  ...
  'coal_mining__bev_smart_charging_optimisation',
  'coal_mining__haul_payload_dispatch_optimisation',
  'coal_mining__ventilation_variable_speed_drives',
  'domestic_aviation__fleet_renewal_aerodynamic',
  'domestic_aviation__flight_ops_optimisation',
  'domestic_shipping__hull_biofouling_air_lubrication',
  'domestic_shipping__slow_steaming_voyage_optimisation',
  ...
  'international_aviation__aero_engine_efficiency_retrofit',
  'international_aviation__operational_efficiency',
  'international_shipping__vessel_speed_route_optimisation',
  'international_shipping__wind_assist_technology',
  'oil_and_gas_extraction__compressor_station_upgrade',
  'oil_and_gas_extraction__electric_compression_smart_load',
  'oil_and_gas_extraction__wellsite_solar_hybrid',
  'rail_freight__dynamic_braking_energy_recovery',
  'rail_freight__train_control_optimisation',
  'rail_passenger__regenerative_braking_upgrade',
  'rail_passenger__timetable_loading_optimisation',
